...
export async function createNalogByDate(datum) {
  const { data } = await httpClient.post("api/dailyreports/for-date", {
    datum,
  });
  return data;
}
...
export async function calculateProsutoRazlika(idNaloga) {
  const { data } = await httpClient.post(
    `api/dailyreports/${idNaloga}/calculate-prosuto-razlika`,
  );
  return data;
}
...
export async function postDailyReportStates(idNaloga, states) {
  const { data } = await httpClient.post(
    `api/dailyreports/${idNaloga}/states`,
    states,
  );
  return data;
}
...
export async function calculateProsutoOnly(idNaloga) {
  const { data } = await httpClient.post(
    `api/dailyreports/${idNaloga}/calculate-prosuto`,
  );
  return data;
}
...
export async function getDailyReportJustByDate(date) {
  const { data } = await httpClient.get(
    `/api/dailyreports/by-date?date=${date}`,
  );
...
export async function postCalculatedProsutoForEachBeer(idNaloga) {
  const { data } = await httpClient.post(
    `/api/dailyreports/${idNaloga}/calculate-prosuto-for-each-beer`,
  );
  return data;
}
...
export async function getProsutoByRangeForEachBeer(from, to) {
  const { data } = await httpClient.get(
    "/api/dailyreports/range-report-for-oneBeer",
    {
      params: { from, to },
    },
  );
...
export async function addBeerQuantity(idNaloga, idPiva, kolicina) {
  ...
  const { data } = await httpClient.patch(
    `/api/dailyreports/${idNaloga}/states/${idPiva}/add`,
    { kolicina },
  );
  return data;
}
...
export async function addMoreBeerQuantity(idNaloga, items) {
  const { data } = await httpClient.patch(
    `/api/dailyreports/${idNaloga}/states/add-batch`,
    items,
  );
  return data;
}
...
export async function getTotalPotrosnjaVagaAndPos(idNaloga) {
  ...
  const { data } = await httpClient.get(
    `/api/dailyreports/${idNaloga}/total-potrosnja-VAGA-POS`,
  );
...
export async function getDayBeforeStates(idNaloga) {
  ...
  const { data } = await httpClient.get(
    `/api/dailyreports/${idNaloga}/day-before-states`,
  );
...
export async function getTotalsSinceLastInventoryReset(idNaloga) {
  ...
  const res = await httpClient.get(
    `/api/dailyreports/${idNaloga}/totals-since-last-inventory`,
  );
  return res.data; // dto
}
...
export async function getKesaItemsForDate(datum) {
  const { data } = await httpClient.get(
    "/api/dailyreports/inventory-reset/kesa-items",
    {
      params: { datum },
    },
  );
...
export async function getInventoryResetDates() {
